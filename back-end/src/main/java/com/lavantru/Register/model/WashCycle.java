...
public class WashCycle {
    ...
    public static List<WashCycle> getWashCycles(){
        ...
        cycles.add (new WashCycle("Fast / Quick / Super Speed","Designed for a small amount of lightly to normal soiled garments needed quickly. Typically, this program allows a load of just 1.5kg, which is equivalent to just one pair of jeans and two shirts."));
        ...
        cycles.add (new WashCycle("Permanent Press / Synthetics","Milder version of the Cotton cycle, often with a lower temperature. This cycle is designed for fabrics that need the agitation of a Regular cycle, but the slow spin of the Delicate cycle as to not wrinkle clothes. It’s recommended primarily for wash-and-wear, synthetic fabrics, and lightly to normally soiled garments. It’s also a good option for items that wrinkle easily, such as dress shirts and pants, or if you want to preserve the finish on wrinkle-free items. An alternative cycle is Colour."));
